...
def send_mail_function(subject="Fire Alert"):
    recipientEmail = "sonamthakur5574@gmail.com"  # Update with your recipient's email address
    recipientEmail = recipientEmail.lower()
    try:
        server = smtplib.SMTP('smtp.gmail.com', 587)
        server.ehlo()
        server.starttls()
        server.login("projectpython365@gmail.com", 'susn lwxx hrsm yxof')  # Update with your Gmail credentials
        ...
        server.sendmail("projectpython365@gmail.com", recipientEmail, message)
